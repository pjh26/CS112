 ...
 *      Author: Peter Haagsma, Jonathon Ellis
 *       Class: CS 112L C
 *
 * 	operator==				Peter Haagsma
 * 	operator!=				Jonathon Ellis
 * 	readFrom(istream)		Peter Haagsma
 * 	writeTo(ostream)		Jonathon Ellis
 * 	readFrom(string)		Jonathon Ellis
 * 	wrtieTo(string)			Peter Haagsma
 * 	prepend(Item)			Peter Haagsma
 * 	getIndexOf(Item)		Jonathon Ellis
 * 	insert(Item, index)		Peter Haagsma
 * 	remove(index)			Jonathon Ellis
 *
 *	All method tests were written by whoever wrote the method
 *
 */
